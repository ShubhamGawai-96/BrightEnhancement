...
//             style={{
//               backgroundImage: `url(../src/assets/${slides[currentIndex].image}.jpg)`,
...
//         <button
//           onClick={prevSlide}
//           className="absolute top-1/2 left-4 -translate-y-1/2 bg-transparent text-black hover:text-white p-2 z-10 "
...
//         <button
//           onClick={nextSlide}
//           className="absolute top-1/2 right-4 -translate-y-1/2 bg-transparent text-black hover:text-white p-2 z-10"
...
//             transition={transition}
//           >
//             <h2 className="text-4xl md:text-6xl font-bold opacity-80">
...
//           className="mt-8 inline-block bg-blue-500 hover:bg-gray-900 text-white py-2 px-6 rounded"
//         >
//           Get Started
//         </a>
//       </div>
